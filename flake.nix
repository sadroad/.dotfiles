{
  ...
  inputs = {
    ...
    # shared
    agenix.url = "github:yaxitech/ragenix/83bccfdea758241999f32869fb6b36f7ac72f1ac";
    my_secrets = {
    ...
    opencode.url = "github:anomalyco/opencode/v1.2.4";
    ...
    handy.url = "github:cjpais/Handy/v0.7.5";
